package com.qa.PairProgrammingAdvanced;
...
public class AppTest 
{
    ...
    {
		Merger m1 = new Merger();
        String sentence = "Digital alarm clocks scare area children.";
        
        assertEquals("Digitalarm clockscarea children.", m1.full(sentence));
    }
